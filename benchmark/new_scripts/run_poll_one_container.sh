...
docker run -p 9093:9093 -p 9094:9094 --net mynet --name poll_con -v $HOME/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/new_scripts/run_poll.sh $1 &
sleep 3
