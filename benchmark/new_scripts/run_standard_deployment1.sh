...
docker run -p 9121:9121 --net mynet --name worker_con -v $HOME/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/new_scripts/run_worker_edpt.sh $1
