...
docker run -p 3003:3000 --net mynet --name make_load_balancer_con -v /home/ubuntu/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/scripts/run_make_load_balancer_logging.sh
...
docker run -p 3001:3000 -p 9089:9089 --net mynet --name worker_con -v /home/ubuntu/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash load_balancer/run_worker.sh &
sleep 5
