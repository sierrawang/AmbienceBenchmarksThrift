...
docker run -p 9089:9089 --net mynet --name lb -v $HOME/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/new_scripts/run_individual_services/run_lb.sh $1 worker_con &
sleep 1
