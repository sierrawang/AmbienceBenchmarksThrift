...
docker run -p 9092:9092 -p 9093:9093 -p 9094:9094 --net mynet --name poll_con -v /home/ubuntu/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/scripts/run_poll_one_container.sh &
sleep 5
