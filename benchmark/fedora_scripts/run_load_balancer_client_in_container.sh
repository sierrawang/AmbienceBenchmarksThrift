...
docker run --net mynet --name client_con -v $HOME/AmbienceBenchmarksThrift:/root/app thrift_img /bin/bash benchmark/fedora_scripts/run_load_balancer_client2.sh
